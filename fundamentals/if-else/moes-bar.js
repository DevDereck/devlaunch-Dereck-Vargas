...
Cálculo de la Edad: Se crea un objeto Date para la fecha de nacimiento y se calcula la edad restando el año de nacimiento del año actual. También se verifica
si ya ha pasado el cumpleaños del año actual, para ajustar la edad si es necesario.
Verificación de Edad: Se utiliza un if-else para determinar si la persona cumple con la edad legal para beber (18 años o más) y se imprime el mensaje
correspondiente.
...
const birthdayPassed = (
    ...
    (
        today.getMonth () === birthday.getMonth () &&
        today.getMonth () >= birthday.getDate ()
    )
)
