...
console.log(`
          ___ Dereck's Hotel ___

  _______________________________________________
  La cantidad de noches a hospedarse es: ${days}
  El precio sin descuento es de: $${subtotal}
  El monto de descuento es de: $${discount}\n
  El monto final a pagar es de: $${totalPrice}
