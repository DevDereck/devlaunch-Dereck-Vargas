...
const favoriteFoodMelverin = prompt('¿What your favorite food Malverin? ')

const isMariaAndPepeSameFavFood = favoriteFoodMaria === favoriteFoodPepe
const isMariaAndMalverinSameFavFood = favoriteFoodMaria === favoriteFoodMelverin

const allMatch = isMariaAndPepeSameFavFood && isMariaAndMalverinSameFavFood
const someMatch = isMariaAndPepeSameFavFood || isMariaAndMalverinSameFavFood
const noMatch = !(isMariaAndPepeSameFavFood || isMariaAndMalverinSameFavFood )
