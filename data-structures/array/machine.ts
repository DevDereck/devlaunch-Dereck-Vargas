...
Si el usuario ingresa una opción inválida, el programa debe pedirle nuevamente hasta que haga
una selección válida.

Después de seleccionar un producto, solicita al usuario que inserte monedas hasta que el monto
...
de moneda. 
Una vez que se alcanza el monto requerido:
Muestra el producto seleccionado y un mensaje confirmando la compra. 
Calcula y muestra cualquier cambio si la cantidad insertada excede el precio del producto.
Limpia la consola después de cada inserción de moneda y solicitud de selección de producto para una experiencia de usuario más limpia.
Ejemplo:
El usuario selecciona el producto A
con un precio de $14.
El usuario comienza a insertar monedas: Inserta
$5 → Balance: $5 Inserta
$10 → Balance : $15
La máquina confirma la compra de y devuelve $1
como cambio. Requisitos Adicionales:
Implementa validación de entrada
para monedas inválidas o entradas no numérica
...
class VendingMachine {
  ...
  public selectProduct = async () => {
    ...
    console.clear();
    console.log(`Product ${food} dispensed!`);
