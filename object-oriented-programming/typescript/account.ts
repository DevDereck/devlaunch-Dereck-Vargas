...
const Account = function(id : string, holderName: string, balance  : number = 0) :AccountShape {
  this.id = id;
...
const acc1: AccountShape = new (Account as any)(1, "Dereck", 10000);
acc1.deposit(1000);
acc1.withdraw(5000);

const acc2 : AccountShape = new (Account as any) (2, "Marifer");
